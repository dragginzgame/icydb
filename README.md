...
Current workspace version: `0.184.23`
...
```toml
[dependencies]
icydb = { git = "https://github.com/dragginzgame/icydb.git", tag = "v0.184.23" }
```
...
```toml
[dependencies]
icydb = { git = "https://github.com/dragginzgame/icydb.git", tag = "v0.184.23", features = ["sql"] }
```
