...
Current workspace version: `0.177.10`
...
```toml
[dependencies]
icydb = { git = "https://github.com/dragginzgame/icydb.git", tag = "v0.177.10" }
```
...
```toml
[dependencies]
icydb = { git = "https://github.com/dragginzgame/icydb.git", tag = "v0.177.10", default-features = false }
```
