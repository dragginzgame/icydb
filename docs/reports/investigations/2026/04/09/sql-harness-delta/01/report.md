...
- current rows: [sql-harness-current.json](/home/adam/projects/icydb/docs/reports/investigations/2026/04/09/sql-harness-delta/01/artifacts/sql-harness-current.json)
- baseline rows: [sql-harness-head.json](/home/adam/projects/icydb/docs/reports/investigations/2026/04/09/sql-harness-delta/01/artifacts/sql-harness-head.json)
- full delta table: [sql-harness-delta.tsv](/home/adam/projects/icydb/docs/reports/investigations/2026/04/09/sql-harness-delta/01/artifacts/sql-harness-delta.tsv)
- run log: [verification-readout.md](/home/adam/projects/icydb/docs/reports/investigations/2026/04/09/sql-harness-delta/01/artifacts/verification-readout.md)
