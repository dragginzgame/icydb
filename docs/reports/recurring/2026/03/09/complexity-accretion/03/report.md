# Complexity Accretion Audit - 2026-03-09 (Rerun 3)
...
| Metric | Baseline (2026-03-09 first run) | Current (2026-03-09 rerun 3) | Delta |
| ---- | ----: | ----: | ----: |
| Runtime files in scope | 310 | 341 | +31 |
| Runtime LOC | 63,342 | 63,214 | -128 |
...
| Area | Baseline (2026-03-09 first run) | Current (2026-03-09 rerun 3) | Delta | Risk |
| ---- | ---- | ---- | ---- | ---- |
...
- This rerun primarily reflects structural decomposition of load execution modules; branch pressure and semantic-owner metrics remained stable.
...
Key conclusion:
- Complexity pressure remains materially improved versus the day's first run.
- Structural decomposition continued without new semantic-owner spread or branch regrowth.
- Remaining drag is concentrated in load-hub size and continuation-surface breadth.
