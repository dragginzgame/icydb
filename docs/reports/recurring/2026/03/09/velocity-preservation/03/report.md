# Velocity Preservation Audit - 2026-03-09 (Rerun 3)
...
| Top gravity-well fan-in proxy | 255 | 196 | -59 |
...
| ---- | ---- | ---- |
| `db/executor/load/*` | 5,978 LOC aggregate, fan-in proxy 196 | Medium-High |
...
- Fan-in remains below the daily baseline despite slight rerun-to-rerun growth, and route-planner HIP remains contained at `1`.
- Slice touch-size history (`avg=15`, `p95=17`) still needs future reduction.
