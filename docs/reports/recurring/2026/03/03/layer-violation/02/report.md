# Cross-Cutting Layer Violation Audit - 2026-03-03 (Rerun 2)
...
| --- | --- | --- | --- |
| `AccessPath` runtime references (`AccessPath::...`) | 112 non-test references | `query`, `access`, `executor`, `cursor` | Medium (structural routing descriptor fan-out across 4 layers) |
...
Interpretation: moderate semantic spread, with the previous comparator-leak hotspot now resolved through index-owned delegation.
