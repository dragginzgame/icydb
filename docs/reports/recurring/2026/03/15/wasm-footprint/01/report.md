...
| --- | --- | --- |
| Wasm size artifacts captured | PASS | size report + summary helpers written |
| Twiggy top breakdown generated | PASS | top text/csv helpers written |
| Twiggy dominator breakdown generated | PASS | dominator text helper written |
| Twiggy monomorphization breakdown generated | PASS | 0 ┊          0.00% ┊     0 ┊ 0.00% ┊ Σ [0 Total Rows] |
| Baseline delta availability | PASS | baseline helper loaded |
