...
The reproducible raw search artifacts for this run were later pruned under the
current report-retention policy; the findings below are the durable record.
