...
- method tag: `PERF-0.3-demo_rpg-pocketic-surface-sampling-expanded`
- status: `PARTIAL`
- comparability: `non-comparable`
- authoritative instruction rows: `present for 25 measured demo_rpg canister scenarios`
...
- This run improves the demo_rpg numeric baseline with grouped `HAVING`,
