# Cursor + Ordering Correctness Audit - 2026-03-03
...
| Strict advancement past anchor | `continuation_advances*` in `index/envelope.rs` and `ensure_continuation_advanced` in `index/scan.rs` | Yes | Low |
