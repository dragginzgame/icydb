...
- `2026-03-01`: 8 reports
- `2026-03-02`: 6 reports
- `2026-03-03`: 19 reports (`summary.md` available at `docs/audits/reports/2026-03/2026-03-03/summary.md`)
...
- `load-entrypoints-cursor-resolution-followup.md`: `1` day(s)
- `load-entrypoints-final-surface-followup.md`: `1` day(s)
- `load-entrypoints-module-split-followup.md`: `1` day(s)
- `load-entrypoints-shape-dispatch-followup.md`: `1` day(s)
...
- `resource-model-compliance.md`: `5` day(s)
...
- monthly summary is an index and coverage rollup
- risk-index trends remain source-of-truth in each day-level `summary.md` and report set
