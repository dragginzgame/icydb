# Cross-Cutting Layer Violation Audit - 2026-03-09 (Rerun 2)

## Report Preamble

- scope: `crates/icydb-core/src/db/` non-test runtime modules
- compared baseline report path: `docs/audits/reports/2026-03/2026-03-09/layer-violation.md`
...
| Surface | Baseline (2026-03-09 first run) | Current (2026-03-09 rerun 2) | Delta | Risk |
| ---- | ----: | ----: | ----: | ---- |
| `AccessPath::` references | 121 | 121 | 0 | Medium-High |
| `AccessPath::` files | 12 | 12 | 0 | Medium |
...
- none required for this rerun; layering ownership and authority metrics stayed stable versus baseline
