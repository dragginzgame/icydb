# Complexity Accretion Audit - 2026-03-09 (Rerun 5)
...
| ---- | ----: | ----: | ----: |
| Runtime files in scope | 310 | 345 | +35 |
| Runtime LOC | 63,342 | 63,269 | -73 |
| Runtime files >= 600 LOC | 17 | 12 | -5 |
| `continuation|anchor` mentions | 1,016 | 1,059 | +43 |
| `continuation|anchor` files | 89 | 103 | +14 |
...
| Area | Baseline (2026-03-09 first run) | Current (2026-03-09 rerun 5) | Delta | Risk |
| ---- | ---- | ---- | ---- | ---- |
...
- This rerun reflects additional load route decomposition
  (`fast_stream_route/{mod.rs,handlers.rs}`) without branch or authority
  regression.
...
- Recent decomposition slices increased module granularity while preserving
  branch and authority invariants.
- Remaining pressure is still concentrated in load-hub size and continuation
  spread.
