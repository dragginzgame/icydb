...
- scope: crosscutting recurring subset run (`complexity-accretion`, `canonical-semantic-authority`, `dry-consolidation`, `layer-violation`, `module-structure`, `velocity-preservation`, `wasm-footprint`)
