...
| Key bound containment in commit-window delegates to index-owned helper | `key_within_bounds -> key_within_envelope(...)` in `executor/mutation/commit_window.rs` | Low |
