...
| --- | ---: | ---: | ---: |
| icp-built `.wasm` | N/A | 2,623,214 | N/A |
| icp-built deterministic `.wasm.gz` | N/A | 843,777 | N/A |
| icp-shrunk `.wasm` | N/A | 2,442,434 | N/A |
| icp-shrunk `.wasm.gz` | N/A | 801,233 | N/A |

## Structural Snapshot (ic-wasm)

| Metric | icp-built | icp-shrunk |
| --- | ---: | ---: |
| Function count | 5,781 | 5,781 |
| Callback count | 1 | 1 |
| Data section count | 3 | 3 |
| Data section bytes | 183,252 | 183,252 |
...
| ---: | --- | ---: | ---: |
| 1 | export "canister_query query_one_simple_fluent" | 640,960 | 26.24% |
| 2 | code[5759] | 640,918 | 26.24% |
| 3 | code[14] | 640,909 | 26.24% |
| 4 | code[12] | 368,119 | 15.07% |
| 5 | code[405] | 213,550 | 8.74% |
| 6 | code[27] | 212,407 | 8.70% |
| 7 | code[25] | 192,058 | 7.86% |
| 8 | data[0] | 182,986 | 7.49% |
| 9 | code[26] | 181,272 | 7.42% |
| 10 | code[80] | 169,010 | 6.92% |
