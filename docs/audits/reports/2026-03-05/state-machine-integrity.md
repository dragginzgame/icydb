# State Machine & Transition Integrity Audit - 2026-03-05
...
- `CommitApplyGuard` rollback closures are transitional; durable correctness remains marker/replay-owned.
- Continuation and grouped route semantics remain the highest coordination-risk transition seams.
