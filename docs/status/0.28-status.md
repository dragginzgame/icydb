...
- [ ] `0.28.0` released (`Cargo.toml` is currently `0.27.9`)
...
Current `0.28.0` status: **feature-complete in-tree; pending version cut and full release gate sweep.**
...
- bump workspace/version metadata for `0.28.0`
