...
- [ ] Parity + invariant matrix completed (deferred to `0.27.1`)

Overall status: **`0.27.0` core implementation is ready; hardening matrix items are tracked for `0.27.1`**.
...
These are intentionally deferred to the first patch release:
