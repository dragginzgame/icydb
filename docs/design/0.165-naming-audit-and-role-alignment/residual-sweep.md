...
```bash
rg -n "LoadOrderRouteContract|GroupedExecutionModeProjection|RouteCapabilities|route::capability\\b|route::contracts::capabilities|CoveringProjectionContext|CoveringAccessMetadata|PreparedExecutionPlanCoreShared|PreparedExecutionInputParts|PlannedCursor|GroupedPlannedCursor|PreparedSqlScalarAggregateDescriptorShape|AggregateTerminalSemantics|resolve_or_insert_global_aggregate_terminal|resolve_having_global_aggregate_terminal_index" crates docs CHANGELOG.md
```
