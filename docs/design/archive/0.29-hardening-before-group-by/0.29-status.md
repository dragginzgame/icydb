...
- `docs/design/archive/0.29-hardening-before-group-by/0.29-design.md`
...
- Structural execution/routing rework from the `db/` audit is moved to `0.30` (`docs/design/archive/0.30-execution-kernel/0.30-design.md`).
...
- [ ] `0.29.0` released
- [x] Design doc created (`docs/design/archive/0.29-hardening-before-group-by/0.29-design.md`)
