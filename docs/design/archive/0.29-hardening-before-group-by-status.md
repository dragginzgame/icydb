...
- `docs/design/archive/0.29-hardening-before-group-by.md`
...
- Structural execution/routing rework from the `db/` audit is moved to `0.30` (`docs/design/archive/0.30-execution-kernel.md`).
...
- [ ] `0.29.0` released
- [x] Design doc created (`docs/design/archive/0.29-hardening-before-group-by.md`)
