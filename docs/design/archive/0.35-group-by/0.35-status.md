...
- [x] grouped fluent exists/first/last terminals (`group_exists`, `group_first`, `group_last`) behavior-covered
- [x] grouped field-target extrema (`group_min_by`, `group_max_by`) explicitly deferred in grouped v1 with fail-fast intent errors

Current `0.35.x` status: **release-ready (pending tag/cut)**.
...
- [x] expand grouped fluent aggregate terminal coverage as needed
- [x] continue grouped boundary cleanup and readability consolidation
- [x] finalize `0.35.0` release notes
