...
This status tracks progress against `docs/design/archive/0.10-index-ordering/0.10-design.md` for the
...
- Canonical freeze note is explicitly documented in
  `docs/design/archive/0.10-index-ordering/0.10-design.md`.
