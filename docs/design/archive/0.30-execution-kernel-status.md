...
- `docs/design/archive/0.30-execution-kernel.md`
...
- [x] 0.30 layer stack is frozen as the audit reference model (`docs/design/archive/0.30-execution-kernel.md`, `Frozen Layer Stack`)
