...
- `docs/design/archive/0.22-streaming-aggregates.md`
...
3. `0.23.0`: execute numeric consolidation and decimal-primitive rewrite from `docs/design/archive/0.23-decimal-consolidation.md`.
