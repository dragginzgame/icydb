...
- `docs/design/archive/0.30-execution-kernel/0.30-design.md`
...
- [x] 0.30 layer stack is frozen as the audit reference model (`docs/design/archive/0.30-execution-kernel/0.30-design.md`, `Frozen Layer Stack`)
