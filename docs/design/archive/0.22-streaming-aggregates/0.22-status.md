...
- `docs/design/archive/0.22-streaming-aggregates/0.22-design.md`
...
3. `0.23.0`: execute numeric consolidation and decimal-primitive rewrite from `docs/design/archive/0.23-decimal-consolidation/0.23-design.md`.
