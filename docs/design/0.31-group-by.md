# 0.31 — GROUP BY & Aggregation Pipeline
...
The following are explicitly **out of scope** for 0.31:
...
0.31 introduces **structural grouping only**.
...
HAVING not supported in 0.31.

---

# 9. Index Interaction Model

Index pushdown for grouping is limited in 0.31.
...
* Index-only grouped aggregate execution in 0.31.
...
# 17. Future Extensions (Post-0.31)
...
After 0.31, the query engine should achieve:
