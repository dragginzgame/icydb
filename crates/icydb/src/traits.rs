pub use icydb_core::traits::{
    ...
    EntityValue, Eq, FieldTypeMeta, From, Hash, Inner, Kind, MapCollection, Mul, MulAssign,
    NumericValue, Ordering, PartialEq, Path, Rem, Sanitize, SanitizeAuto, SanitizeCustom,
