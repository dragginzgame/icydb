...
pub mod model {
    ...
    pub mod field {
        pub use icydb_core::model::{
            EnumVariantModel, FieldKind, FieldModel, FieldStorageDecode, RelationStrength,
        };
    }

    pub mod index {
        pub use icydb_core::model::{IndexExpression, IndexKeyItem, IndexKeyItemsRef, IndexModel};
    }
