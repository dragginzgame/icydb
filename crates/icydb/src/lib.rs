...
pub mod design {
    pub mod prelude {
        ...
        pub use crate::{
            ...
            macros::*,
            traits::{
                AsView, Collection as _, Create, EntityKind, EntityValue as _, FieldValue as _,
                Inner as _, MapCollection as _, Path as _, Sanitize as _, Sanitizer,
                Serialize as _, Update, Validate as _, ValidateCustom, Validator, View,
                Visitable as _,
            },
            types::*,
            value::Value,
