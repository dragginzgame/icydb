...
not re-exported here. The runtime-only `#[icydb::request_execution]` and
`#[icydb::test]` entry attributes are exposed directly by this facade.
Schema-proposal vocabulary and canonical scalar metadata live in
`icydb-schema`.
