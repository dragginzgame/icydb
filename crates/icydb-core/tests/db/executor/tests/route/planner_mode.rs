fn kernel_aggregate_mod_source() -> &'static str {
    include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../kernel/aggregate/mod.rs"))
}

fn kernel_aggregate_fast_path_source() -> &'static str {
    include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../kernel/aggregate/fast_path.rs"))
}

fn kernel_aggregate_field_extrema_source() -> &'static str {
    include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../kernel/aggregate/field_extrema.rs"))
}

#[test]
fn load_fast_path_resolution_is_gated_by_route_execution_mode() {
    let execute_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../load/execute.rs"));
...
fn load_trace_outcome_mapping_is_single_owner_boundary() {
    let load_mod_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../load/mod.rs"));
...
fn route_planner_remains_decomposed_into_dedicated_submodules() {
    let planner_mod_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../route/planner/mod.rs"));
...
fn ranked_terminal_families_share_one_ranked_row_helper() {
    let terminal_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../load/terminal/mod.rs"));
    assert!(
...
fn aggregate_execution_mode_selection_is_route_owned_and_explicit() {
    let aggregate_terminals_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../load/aggregate/terminals.rs"));
    let kernel_aggregate_source = kernel_aggregate_mod_source();
    let distinct_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../load/aggregate/distinct.rs"));
    let aggregate_contracts_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../aggregate_model/contracts.rs"));
...
fn aggregate_generic_streaming_fold_is_kernel_reducer_owned() {
    ...
    let kernel_reducer_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../kernel/reducer.rs"));
    let aggregate_contracts_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../aggregate_model/contracts.rs"));
...
fn aggregate_streaming_paths_share_one_preparation_boundary() {
    let load_aggregate_root_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../load/aggregate/mod.rs"));
    let kernel_aggregate_mod_source = kernel_aggregate_mod_source();
    let kernel_aggregate_field_extrema_source = kernel_aggregate_field_extrema_source();
    let executor_window_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../window.rs"));
    let aggregate_contracts_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../aggregate_model/contracts.rs"));
...
fn cursor_spine_validates_signature_direction_and_window_shape() {
    let cursor_spine_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../../cursor/spine.rs"));
...
fn post_access_runtime_ownership_is_kernel_scoped() {
    let executor_mod_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../mod.rs"));
    let kernel_mod_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../kernel/mod.rs"));
...
fn load_row_collector_runner_remains_kernel_ordered_and_single_owner() {
    ...
    let load_mod_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../load/mod.rs"));
    let load_execute_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../load/execute.rs"));
