...
fn load_stream_construction_routes_through_route_facade() {
    let load_sources = [
        (
            ...
            include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../load/aggregate/mod.rs")),
        ),
        ("load/execute.rs", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../load/execute.rs"))),
        (
            "load/fast_stream.rs",
            include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../load/fast_stream.rs")),
        ),
        (
            "load/index_range_limit.rs",
            include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../load/index_range_limit.rs")),
        ),
        ("load/pk_stream.rs", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../load/pk_stream.rs"))),
        (
            "load/secondary_index.rs",
            include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../load/secondary_index.rs")),
        ),
    ];
...
fn aggregate_fast_path_dispatch_requires_verified_gate_marker() {
    let aggregate_fast_path_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../kernel/aggregate/fast_path.rs"));
    assert!(
...
fn strict_index_predicate_compile_policy_has_one_executor_source_of_truth() {
    let planner_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../route/planner/mod.rs"));
    let planner_fast_path_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../route/planner/fast_path.rs"));
    let executor_compile_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../index_predicate.rs"));
...
fn aggregate_fast_path_folding_uses_shared_stream_helpers() {
    let aggregate_fast_path_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../kernel/aggregate/fast_path.rs"));
    let kernel_aggregate_source = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/db/executor/tests/route/", "../../kernel/aggregate/fast_path.rs"));
