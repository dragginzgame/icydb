...
/// Check whether canonical ordering and deduplication would leave a set unchanged.
pub(crate) fn value_set_is_strictly_canonical<T: Borrow<Value>>(values: &[T]) -> bool {
