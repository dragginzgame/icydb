...
pub(crate) const UNCHECKED_SINGLE_RELATION_SOURCE_ENTITY_TAG: EntityTag = EntityTag::new(0x1021);
pub(crate) const UNCHECKED_OPTIONAL_RELATION_SOURCE_ENTITY_TAG: EntityTag = EntityTag::new(0x1022);
pub(crate) const UNCHECKED_LIST_RELATION_SOURCE_ENTITY_TAG: EntityTag = EntityTag::new(0x1023);
...
pub(crate) const UNCHECKED_SET_RELATION_SOURCE_ENTITY_TAG: EntityTag = EntityTag::new(0x1051);
...
pub(crate) const OPTIONAL_COMPOSITE_RELATION_SOURCE_ENTITY_TAG: EntityTag = EntityTag::new(0x105C);
pub(crate) const COMPOSITE_PK_RELATION_SOURCE_ENTITY_TAG: EntityTag = EntityTag::new(0x105D);
...
const ALL_TEST_ENTITY_TAGS: &[EntityTag] = &[
    ...
    UNCHECKED_SINGLE_RELATION_SOURCE_ENTITY_TAG,
    UNCHECKED_OPTIONAL_RELATION_SOURCE_ENTITY_TAG,
    UNCHECKED_LIST_RELATION_SOURCE_ENTITY_TAG,
    ...
    UNCHECKED_SET_RELATION_SOURCE_ENTITY_TAG,
    ...
    OPTIONAL_COMPOSITE_RELATION_SOURCE_ENTITY_TAG,
    COMPOSITE_PK_RELATION_SOURCE_ENTITY_TAG,
