...
mod tests {
    ...
    fn scalar_index_range_token_fixture() -> ContinuationToken {
        ContinuationToken::new_index_range_with_direction(
            ...
            CursorBoundary {
                slots: vec![CursorBoundarySlot::Present(Value::Nat64(11))],
            },
    ...
    fn continuation_token_wire_vector_is_frozen() {
        ...
        assert_eq!(
            actual_hex,
            "49435951010124242424242424242424242424242424242424242424242424242424242424240000000003000000020113000000000000000701110000000874656e616e742d6100",
    ...
    fn continuation_token_index_range_anchor_wire_vector_is_frozen() {
        ...
        assert_eq!(
            actual_hex,
            "49435951010151515151515151515151515151515151515151515151515151515151515151510000000009000000010113000000000000000b0100000003aabbcc",
