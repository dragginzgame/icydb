...
#[test]
fn execute_sql_ddl_rejects_generated_index_drop_with_actionable_message() {
    ...
    assert!(
        message.contains("generated by the entity model"),
        "generated index drops should say which authority owns the index",
    );
    assert!(
