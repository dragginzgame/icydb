...
fn execute_sql_filtered_expression_index_range_scan_preserves_lower_handle_order() {
    ...
    assert_eq!(
        ...
        vec![
            (
                PrimaryKeyComponent::Ulid(Ulid::from_u128(9_232)),
                PrimaryKeyComponent::Ulid(Ulid::from_u128(9_232))
            ),
            (
                PrimaryKeyComponent::Ulid(Ulid::from_u128(9_234)),
                PrimaryKeyComponent::Ulid(Ulid::from_u128(9_234))
            ),
            (
                PrimaryKeyComponent::Ulid(Ulid::from_u128(9_233)),
                PrimaryKeyComponent::Ulid(Ulid::from_u128(9_233))
            ),
            (
                PrimaryKeyComponent::Ulid(Ulid::from_u128(9_235)),
                PrimaryKeyComponent::Ulid(Ulid::from_u128(9_235))
            ),
        ],
