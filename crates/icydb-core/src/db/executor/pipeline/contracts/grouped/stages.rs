...
pub(in crate::db::executor) struct GroupedStreamStage<'a, E: EntityKind + EntityValue> {
    ctx: Context<'a, E>,
    ...
    E: EntityKind + EntityValue,
{
    ...
    pub(in crate::db::executor) fn rows_scanned(&self, fallback: usize) -> usize {
...
impl GroupedFoldStage {
    ...
    pub(in crate::db::executor) fn from_grouped_stream<E>(
        page: GroupedCursorPage,
        filtered_rows: usize,
        check_filtered_rows_upper_bound: bool,
