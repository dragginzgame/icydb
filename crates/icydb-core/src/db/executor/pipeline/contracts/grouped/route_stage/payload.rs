...
//! Responsibility: module-local ownership and contracts for db::executor::pipeline::contracts::grouped::route_stage::payload.
...
use crate::db::{
    ...
    query::plan::{
        ...
        GroupedAggregateProjectionSpec, GroupedDistinctExecutionStrategy, GroupedExecutionConfig,
        GroupedPlanStrategy, PlannedProjectionLayout,
    },
};
...
pub(in crate::db::executor) struct GroupedPlannerPayload {
    ...
    pub(in crate::db::executor) grouped_aggregate_projection_specs:
