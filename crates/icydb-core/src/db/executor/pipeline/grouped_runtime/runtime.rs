...
use crate::db::{
    direction::Direction,
    executor::{
        ExecutionTrace, pipeline::grouped_runtime::GroupedContinuationContext,
...
pub(in crate::db::executor) struct GroupedRuntimeProjection {
    direction: Direction,
...
impl GroupedRuntimeProjection {
    ...
    pub(in crate::db::executor) const fn into_execution_trace(self) -> Option<ExecutionTrace> {
