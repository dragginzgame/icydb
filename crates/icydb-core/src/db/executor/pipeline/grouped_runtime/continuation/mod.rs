//! Module: db::executor::pipeline::grouped_runtime::continuation
//! Responsibility: module-local ownership and contracts for db::executor::pipeline::grouped_runtime::continuation.
