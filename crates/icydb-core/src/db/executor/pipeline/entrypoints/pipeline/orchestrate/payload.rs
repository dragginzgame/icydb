//! Module: db::executor::pipeline::entrypoints::pipeline::orchestrate::payload
//! Responsibility: module-local ownership and contracts for db::executor::pipeline::entrypoints::pipeline::orchestrate::payload.
