//! Module: executor::pipeline::execute::fast_path
...
//! Boundary: internal helper boundary for `executor::pipeline::execute`.
...
use crate::db::executor::pipeline::execute::fast_path::strategy::{
