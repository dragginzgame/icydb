...
//! Responsibility: owns payload state contracts for load runtime orchestration.
...
/// Carries the selected mode, one required payload, and optional trace output.
///
