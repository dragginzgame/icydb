...
use crate::db::executor::aggregate::contracts::{
    ...
    state::{AggregateState, AggregateStateFactory, FoldControl, TerminalAggregateState},
};
...
impl<E: EntityKind> AggregateEngine<E> {
    ...
    pub(in crate::db::executor) fn ingest_scalar(
        ...
        match self {
            ...
            Self::Grouped(_) => Err(crate::db::error::executor_invariant(
    ...
    pub(in crate::db::executor) fn ingest_grouped(
        ...
        match self {
            ...
            Self::Scalar(_) => Err(GroupError::Internal(crate::db::error::executor_invariant(
    ...
    pub(in crate::db::executor) fn finalize_grouped(
        ...
        match self {
            ...
            Self::Scalar(_) => Err(crate::db::error::executor_invariant(
