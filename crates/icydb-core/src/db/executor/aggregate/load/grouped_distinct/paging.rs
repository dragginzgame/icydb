//! Module: db::executor::aggregate::load::grouped_distinct::paging
//! Responsibility: module-local ownership and contracts for db::executor::aggregate::load::grouped_distinct::paging.
