//! Module: db::executor::aggregate::load::grouped_distinct::aggregate
//! Responsibility: module-local ownership and contracts for db::executor::aggregate::load::grouped_distinct::aggregate.
