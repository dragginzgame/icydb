//! Module: db::executor::aggregate::load::grouped_fold::ingest
//! Responsibility: module-local ownership and contracts for db::executor::aggregate::load::grouped_fold::ingest.
