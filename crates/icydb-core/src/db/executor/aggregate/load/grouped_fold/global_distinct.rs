//! Module: db::executor::aggregate::load::grouped_fold::global_distinct
//! Responsibility: module-local ownership and contracts for db::executor::aggregate::load::grouped_fold::global_distinct.
