//! Module: db::executor::aggregate::load::grouped_fold::engine_init
//! Responsibility: module-local ownership and contracts for db::executor::aggregate::load::grouped_fold::engine_init.
