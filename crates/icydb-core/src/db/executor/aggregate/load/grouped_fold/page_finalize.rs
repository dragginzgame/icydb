//! Module: db::executor::aggregate::load::grouped_fold::page_finalize
//! Responsibility: module-local ownership and contracts for db::executor::aggregate::load::grouped_fold::page_finalize.
