//! Module: db::executor::aggregate::load::grouped_fold::candidate_rows::sink
//! Responsibility: module-local ownership and contracts for db::executor::aggregate::load::grouped_fold::candidate_rows::sink.
