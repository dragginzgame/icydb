//! Module: db::executor::aggregate::load::grouped_output::finalize
//! Responsibility: module-local ownership and contracts for db::executor::aggregate::load::grouped_output::finalize.
