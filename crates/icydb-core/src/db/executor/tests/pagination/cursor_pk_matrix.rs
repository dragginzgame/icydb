//! Module: db::executor::tests::pagination::cursor_pk_matrix
//! Responsibility: module-local ownership and contracts for db::executor::tests::pagination::cursor_pk_matrix.
