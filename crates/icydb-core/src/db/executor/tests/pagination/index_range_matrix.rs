//! Module: db::executor::tests::pagination::index_range_matrix
//! Responsibility: module-local ownership and contracts for db::executor::tests::pagination::index_range_matrix.
