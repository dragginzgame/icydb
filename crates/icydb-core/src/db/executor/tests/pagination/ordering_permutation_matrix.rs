//! Module: db::executor::tests::pagination::ordering_permutation_matrix
//! Responsibility: module-local ownership and contracts for db::executor::tests::pagination::ordering_permutation_matrix.
