//! Module: db::executor::tests::pagination::limit_no_cursor_matrix
//! Responsibility: module-local ownership and contracts for db::executor::tests::pagination::limit_no_cursor_matrix.
