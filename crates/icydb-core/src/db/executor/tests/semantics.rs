...
index_prefix_specs=[{index:group_rank,bound_type:equality,lower:included(len:37:head:0000000000000010:tail:0007000100000100),upper:included(len:4194:head:0000000000000010:tail:ffffffffffffffff)}]
index_range_specs=[]
...
index_prefix_specs=[]
index_range_specs=[{index:code_unique,lower:included(len:34:head:0000000000000010:tail:0000000064000100),upper:excluded(len:34:head:0000000000000010:tail:00000000c8000100)}]
