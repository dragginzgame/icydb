...
fn route_feature_budget_no_eligibility_helpers_outside_route_module() {
    let aggregate_source = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/db/executor/tests/route/",
        "../../aggregate/mod.rs"
    ));
    let aggregate_orchestration_source = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/db/executor/tests/route/",
        "../../aggregate/mod.rs"
    ));
    ...
    let aggregate_field_extrema_source = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/db/executor/tests/route/",
    ...
    let index_range_limit_source = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/db/executor/tests/route/",
        "../../load/index_range_limit.rs"
    ));
    let page_source = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/db/executor/tests/route/",
        "../../load/page.rs"
    ));
    let pk_stream_source = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/db/executor/tests/route/",
        "../../load/pk_stream.rs"
    ));
    let secondary_index_source = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/db/executor/tests/route/",
    ...
    assert_no_eligibility_helper_defs("aggregate/mod.rs", aggregate_orchestration_source);
    assert_no_eligibility_helper_defs("aggregate/fast_path.rs", aggregate_fast_path_source);
    assert_no_eligibility_helper_defs("aggregate/field_extrema.rs", aggregate_field_extrema_source);
