...
fn route_plan_load_uses_route_owned_fast_path_order() {
    ...
    let route_plan =
        build_load_route_plan_for_entity::<RouteMatrixEntity>(&plan, &initial_scalar_continuation_context())
...
fn route_matrix_load_index_range_cursor_without_anchor_disables_pushdown() {
    ...
    let route_plan = build_load_route_plan_for_entity::<RouteMatrixEntity>(&plan, &continuation)
        .expect("load route plan should build");
...
fn route_matrix_load_unique_secondary_order_limit_one_uses_bounded_scan_budget_hint() {
    ...
    let route_plan = build_load_route_plan_for_entity::<UniqueIndexRangeEntity>(
        &plan,
...
fn route_matrix_load_by_keys_desc_disables_fallback_fetch_hint_without_reverse_support() {
    ...
    let route_plan = build_load_route_plan_for_entity_with_probe_hint::<RouteMatrixEntity>(
        &plan,
        &initial_scalar_continuation_context(),
        Some(4),
    )
...
fn route_matrix_load_desc_reverse_support_gate_allows_and_blocks_fetch_hint() {
    ...
    let reverse_capable_route = build_load_route_plan_for_entity_with_probe_hint::<
        RouteMatrixEntity,
    >(
        &reverse_capable,
        &initial_scalar_continuation_context(),
    ...
    let reverse_blocked_route = build_load_route_plan_for_entity_with_probe_hint::<
        RouteMatrixEntity,
    >(
        &reverse_blocked,
        &initial_scalar_continuation_context(),
