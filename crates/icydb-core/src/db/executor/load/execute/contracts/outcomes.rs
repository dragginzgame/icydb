//! Module: db::executor::load::execute::contracts::outcomes
//! Responsibility: module-local ownership and contracts for db::executor::load::execute::contracts::outcomes.
//! Does not own: cross-module orchestration outside this module.
//! Boundary: exposes this module API while keeping implementation details internal.

use crate::{
    db::executor::{ExecutionOptimization, load::CursorPage},
    traits::EntityKind,
};
