//! Module: db::executor::load::grouped_runtime::continuation::capabilities
//! Responsibility: module-local ownership and contracts for db::executor::load::grouped_runtime::continuation::capabilities.
//! Does not own: cross-module orchestration outside this module.
//! Boundary: exposes this module API while keeping implementation details internal.

use crate::db::executor::load::GroupedPaginationWindow;
