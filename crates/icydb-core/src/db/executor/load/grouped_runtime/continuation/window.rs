//! Module: db::executor::load::grouped_runtime::continuation::window
//! Responsibility: module-local ownership and contracts for db::executor::load::grouped_runtime::continuation::window.
