//! Module: db::executor::load::projection::grouped
//! Responsibility: module-local ownership and contracts for db::executor::load::projection::grouped.
...
pub(in crate::db::executor) struct GroupedRowView<'a> {
    pub(in crate::db::executor::load::projection) key_values: &'a [Value],
    pub(in crate::db::executor::load::projection) aggregate_values: &'a [Value],
    pub(in crate::db::executor::load::projection) group_fields: &'a [FieldSlot],
    pub(in crate::db::executor::load::projection) aggregate_exprs: &'a [AggregateExpr],
}
...
pub(in crate::db::executor::load::projection) fn resolve_group_field_offset(
...
pub(in crate::db::executor::load::projection) fn resolve_grouped_aggregate_index(
    grouped_row: &GroupedRowView<'_>,
