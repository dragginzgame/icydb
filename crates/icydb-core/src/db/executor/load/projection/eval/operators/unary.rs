//! Module: db::executor::load::projection::eval::operators::unary
//! Responsibility: module-local ownership and contracts for db::executor::load::projection::eval::operators::unary.
