//! Module: db::executor::load::grouped_route::resolve
//! Responsibility: module-local ownership and contracts for db::executor::load::grouped_route::resolve.
    ...
    E: EntityKind + EntityValue,
{
    ...
    pub(in crate::db::executor::load) fn resolve_grouped_route(
