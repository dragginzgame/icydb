//! Module: db::executor::load::terminal::ranking::materialized::projections
//! Responsibility: module-local ownership and contracts for db::executor::load::terminal::ranking::materialized::projections.
//! Does not own: cross-module orchestration outside this module.
//! Boundary: exposes this module API while keeping implementation details internal.

use crate::{
    db::{
        executor::{aggregate::field::FieldSlot, load::LoadExecutor},
    ...
    E: EntityKind + EntityValue,
{
    ...
    pub(in crate::db::executor::load::terminal::ranking) fn top_k_field_from_materialized(
    ...
    pub(in crate::db::executor::load::terminal::ranking) fn top_k_field_values_from_materialized(
        response: EntityResponse<E>,
        target_field: &str,
        field_slot: FieldSlot,
        take_count: u32,
    ...
    pub(in crate::db::executor::load::terminal::ranking) fn top_k_field_values_with_ids_from_materialized(
        response: EntityResponse<E>,
        target_field: &str,
        field_slot: FieldSlot,
        take_count: u32,
    ...
    pub(in crate::db::executor::load::terminal::ranking) fn bottom_k_field_from_materialized(
        response: EntityResponse<E>,
        target_field: &str,
        field_slot: FieldSlot,
        take_count: u32,
    ...
    pub(in crate::db::executor::load::terminal::ranking) fn bottom_k_field_values_from_materialized(
        response: EntityResponse<E>,
        target_field: &str,
        field_slot: FieldSlot,
        take_count: u32,
    ...
    pub(in crate::db::executor::load::terminal::ranking) fn bottom_k_field_values_with_ids_from_materialized(
        response: EntityResponse<E>,
        target_field: &str,
        field_slot: FieldSlot,
        take_count: u32,
