//! Module: db::executor::load::entrypoints::pipeline::orchestrate::guards
//! Responsibility: module-local ownership and contracts for db::executor::load::entrypoints::pipeline::orchestrate::guards.
//! Does not own: cross-module orchestration outside this module.
//! Boundary: exposes this module API while keeping implementation details internal.

use crate::{
    db::executor::load::entrypoints::pipeline::orchestrate::state::{
