use crate::{
    db::{
        ...
        executor::{
            ...
            aggregate_model::{AggregateKind, AggregateOutput},
...
impl ExecutionKernel {
    ...
    pub(in crate::db::executor::kernel::aggregate) fn aggregate_field_extrema_from_materialized<E>(
        response: Response<E>,
        kind: AggregateKind,
        target_field: &str,
    ...
    pub(in crate::db::executor::kernel::aggregate) fn execute_field_target_extrema_aggregate<E>(
