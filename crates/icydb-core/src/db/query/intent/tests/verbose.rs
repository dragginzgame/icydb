...
fn explain_execution_verbose_top_n_seek_shape_snapshot_is_stable() {
    ...
    let expected = vec![
        ...
        "diag.r.limit_stop_after=possible(limit=3,lookahead=1,fetch=6)",
        "diag.r.predicate_stage=none",
        "diag.r.residual_filter_shape=none",
        "diag.r.projected_fields=[\"id\", \"rank\"]",
        "diag.r.load_order_route_mode=direct_streaming",
        "diag.r.load_order_route_reason=none",
        "diag.r.projection_pushdown=false",
        "diag.r.covering_read=order_mat",
        "diag.r.covering_kind=materialized",
        "diag.r.access_choice_chosen=FullScan",
        "diag.r.access_choice_chosen_reason=planner_full_scan_fallback",
        ...
        "diag.p.predicate_pushdown_outcome=none",
        "diag.p.predicate_pushdown_reason=no_filter",
...
fn explain_execution_verbose_temporal_ranked_shape_snapshot_is_stable() {
    ...
    let expected = vec![
        ...
        "diag.r.index_range_limit_pushdown=disabled",
        "diag.r.limit_stop_after=disabled(requires_materialized_sort)",
        "diag.r.predicate_stage=none",
        "diag.r.residual_filter_shape=none",
        ...
        "diag.r.order_by_idx_hint=occurred_on DESC, id ASC",
        "diag.r.projection_pushdown=false",
        "diag.r.covering_read=order_mat",
        "diag.r.covering_kind=materialized",
        "diag.r.access_choice_chosen=FullScan",
...
fn explain_execution_verbose_rejection_shape_snapshot_is_stable() {
    ...
    let expected = vec![
        ...
        "diag.r.load_order_route_mode=materialized_fallback",
        "diag.r.load_order_route_reason=requires_materialized_sort",
        "diag.r.order_by_idx_hint=label ASC, id ASC",
        "diag.r.projection_pushdown=false",
        "diag.r.covering_read=order_mat",
        "diag.r.covering_kind=materialized",
        ...
        "diag.p.predicate_pushdown_outcome=full",
        "diag.p.predicate_pushdown_reason=access_path_applied",
        "diag.p.distinct=false",
        "diag.p.page=None",
        "diag.p.consistency=Ignore",
    ]
...
fn explain_execution_verbose_index_range_pushdown_shape_snapshot_is_stable() {
    ...
    let expected = vec![
        ...
        "diag.r.load_order_route_mode=materialized_fallback",
        "diag.r.load_order_route_reason=residual_filter_blocks_direct_streaming",
        "diag.r.order_by_idx_hint=code ASC, id ASC",
        "diag.r.projection_pushdown=false",
        "diag.r.covering_read=order_mat",
        "diag.r.covering_kind=materialized",
        ...
        "diag.p.predicate_pushdown_outcome=partial",
        "diag.p.predicate_pushdown_reason=residual_after_access",
        "diag.p.distinct=false",
        "diag.p.page=Page { limit: Some(2), offset: 0 }",
        "diag.p.consistency=Ignore",
    ]
...
fn explain_execution_verbose_non_strict_fallback_shape_snapshot_is_stable() {
    ...
    let expected = vec![
        ...
        "diag.p.predicate_pushdown_outcome=fallback",
        "diag.p.predicate_pushdown_reason=non_strict_compare_coercion",
        "diag.p.distinct=false",
        "diag.p.page=None",
        "diag.p.consistency=Ignore",
    ]
...
fn explain_execution_verbose_is_null_fallback_shape_snapshot_is_stable() {
    ...
    let expected = vec![
        ...
        "diag.p.predicate_pushdown_outcome=fallback",
        "diag.p.predicate_pushdown_reason=is_null_full_scan",
        "diag.p.distinct=false",
        "diag.p.page=None",
        "diag.p.consistency=Ignore",
    ]
