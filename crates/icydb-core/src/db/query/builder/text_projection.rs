...
impl TextProjectionExpr {
    ...
    pub(in crate::db) fn position(field: impl Into<String>, literal: impl Into<Value>) -> Self {
        let field = field.into();
...
#[must_use]
pub fn substring(field: impl AsRef<str>, start: impl Into<Value>) -> TextProjectionExpr {
