...
use crate::db::{
    predicate::Predicate,
    query::plan::expr::{
        Expr, canonicalize_runtime_predicate_via_bool_expr,
...
#[must_use]
#[cfg(test)]
fn compile_bool_expr_to_predicate(expr: &Expr) -> Predicate {
...
mod tests {
    use crate::{
        db::{
            ...
            query::plan::expr::{
                ...
                canonicalize_runtime_predicate_via_bool_expr, canonicalize_scalar_where_bool_expr,
    ...
    use super::{canonicalize_predicate_via_bool_expr, compile_bool_expr_to_predicate};
