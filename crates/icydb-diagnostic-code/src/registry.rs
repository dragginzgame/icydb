...
define_error_code_registry! {
    ...
    RUNTIME_BOUNDARY_MUTATION_BATCH_STORE_MISMATCH = 239 => RuntimeConflict,
    ...
    RUNTIME_BOUNDARY_MUTATION_BATCH_TOO_MANY_ENTITIES = 285 => RuntimeUnsupported,
