...
INDEX_EXECUTOR_FILES=(
  "crates/icydb-core/src/db/executor/composite_stream.rs"
...
REQUIRED_MATCHES=(
  "crates/icydb-core/src/db/executor/context.rs:::unused index-prefix executable specs after access-plan traversal:::missing invariant check for unused IndexPrefixSpec entries"
