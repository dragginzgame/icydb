...
INDEX_EXECUTOR_FILES=(
  "crates/icydb-core/src/db/executor/access_stream.rs"
...
REQUIRED_MATCHES=(
  "crates/icydb-core/src/db/executor/access_stream.rs:::unused index-prefix executable specs after access-plan traversal:::missing invariant check for unused IndexPrefixSpec entries"
  ...
  "crates/icydb-core/src/db/executor/access_stream.rs:::index-prefix spec does not match access path index:::missing invariant error for misaligned IndexPrefixSpec consumption"
  ...
  "crates/icydb-core/src/db/executor/access_stream.rs:::unused index-range executable specs after access-plan traversal:::missing invariant check for unused IndexRangeSpec entries"
  ...
  "crates/icydb-core/src/db/executor/access_stream.rs:::index-range spec does not match access path index:::missing invariant error for misaligned IndexRangeSpec consumption"
