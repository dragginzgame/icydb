...
echo "  2. Run 'make patch' (or minor/major) to bump version files"
echo "  3. Review the release diff"
echo "  4. Run 'make release-stage' to stage known release files"
echo "  5. Run 'make release-commit' to commit and tag the release"
echo "  6. Run 'make release-push' to publish the release tag"
echo "  7. Verify CI workflows complete successfully"
echo ""
print_info "For more information, see project release docs in README.md and CHANGELOG.md"
