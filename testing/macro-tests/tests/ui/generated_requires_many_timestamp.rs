...
#[entity(source_key = "testing/macro-tests/tests/ui/generated_requires_many_timestamp.rs::entity::1",
    store = "UiDataStore",
    version = 1,
    pk(fields = ["id"]),
    fields(
        ...
        field(source_key = "created_on_insert", ident = "created_on_insert",
            value(many, item(prim = "Timestamp")),
            generated(insert = "Timestamp::now")
        )
    )
)]
pub struct InvalidManyGeneratedTimestampField;
