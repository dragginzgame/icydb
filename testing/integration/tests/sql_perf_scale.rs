...
const SCALE_SENTINEL_SPECS: &[ScaleSentinelSpec] = &[
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.secondary_order.all.first_age.window1",
        p1_scenario_id: "user.select.pk.all.age_asc.limit1",
        sql_override: Some("SELECT age FROM PerfAuditUser ORDER BY age ASC, id ASC LIMIT 1"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::SecondaryOrder,
        selectivity: ScaleSelectivity::All,
        result_window: Some(1),
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.secondary_order.all.last_age.window1",
        p1_scenario_id: "user.select.pk.all.age_desc.limit1",
        sql_override: Some("SELECT age FROM PerfAuditUser ORDER BY age DESC, id DESC LIMIT 1"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::SecondaryOrder,
        selectivity: ScaleSelectivity::All,
        result_window: Some(1),
    ...
    ScaleSentinelSpec {
        sentinel_id: "heap_user.materialized_order.all.window1",
        p1_scenario_id: "heap_user.select.pk.all.age_asc.limit1",
        sql_override: None,
        surface: MatrixSurface::HeapUser,
        route_family: RouteFamily::MaterializedOrder,
        selectivity: ScaleSelectivity::All,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.count_nonnull_id_all",
        p1_scenario_id: "user.aggregate.count_all",
        sql_override: Some("SELECT COUNT(id) FROM PerfAuditUser"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::All,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.count_constant_one_all",
        p1_scenario_id: "user.aggregate.count_all",
        sql_override: Some("SELECT COUNT(1) FROM PerfAuditUser"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::All,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.count_true_all",
        p1_scenario_id: "user.aggregate.count_all",
        sql_override: Some("SELECT COUNT(*) FROM PerfAuditUser WHERE true"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::All,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.count_indexed_in_all",
        p1_scenario_id: "user.aggregate.count_age_in",
        sql_override: Some("SELECT COUNT(*) FROM PerfAuditUser WHERE age IN (31, 32, 33, 34, 43)"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::All,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.count_indexed_range_quarter",
        p1_scenario_id: "user.aggregate.count_active",
        sql_override: Some("SELECT COUNT(*) FROM PerfAuditUser WHERE age >= 24 AND age < 40"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::Quarter,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.avg_secondary_all",
        p1_scenario_id: "user.aggregate.sum_age",
        sql_override: Some("SELECT AVG(age) FROM PerfAuditUser"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::All,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.count_distinct_secondary_all",
        p1_scenario_id: "user.contract.aggregate_distinct_filter",
        sql_override: Some("SELECT COUNT(DISTINCT age) FROM PerfAuditUser"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::All,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.min_primary_all",
        p1_scenario_id: "user.aggregate.count_all",
        sql_override: Some("SELECT MIN(id) FROM PerfAuditUser"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::All,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.max_primary_all",
        p1_scenario_id: "user.aggregate.count_all",
        sql_override: Some("SELECT MAX(id) FROM PerfAuditUser"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::All,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.min_secondary_all",
        p1_scenario_id: "user.aggregate.count_all",
        sql_override: Some("SELECT MIN(age) FROM PerfAuditUser"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::All,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.max_secondary_all",
        p1_scenario_id: "user.aggregate.count_all",
        sql_override: Some("SELECT MAX(age) FROM PerfAuditUser"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::All,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.min_secondary_range_all",
        p1_scenario_id: "user.aggregate.count_all",
        sql_override: Some("SELECT MIN(age) FROM PerfAuditUser WHERE age >= 31"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::All,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.max_secondary_range_quarter",
        p1_scenario_id: "user.aggregate.count_all",
        sql_override: Some("SELECT MAX(age) FROM PerfAuditUser WHERE age < 43"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::Quarter,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.min_computed_all",
        p1_scenario_id: "user.aggregate.count_all",
        sql_override: Some("SELECT MIN(age + 1) FROM PerfAuditUser"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::All,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.secondary_distinct.all.window3",
        p1_scenario_id: "user.contract.scalar_distinct",
        sql_override: None,
        surface: MatrixSurface::User,
        route_family: RouteFamily::SecondaryOrder,
        selectivity: ScaleSelectivity::All,
        result_window: Some(3),
        payload_profile: ScalePayloadProfile::NotApplicable,
        grouped: None,
    },
    ScaleSentinelSpec {
        sentinel_id: "user.secondary_order.all.age.window3",
        p1_scenario_id: "user.select.pk.all.age_asc.limit3",
        sql_override: Some("SELECT age FROM PerfAuditUser ORDER BY age ASC, id ASC LIMIT 3"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::SecondaryOrder,
        selectivity: ScaleSelectivity::All,
        result_window: Some(3),
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.primary_projection_all",
        p1_scenario_id: "user.contract.exact_primary_key",
        sql_override: Some("SELECT id FROM PerfAuditUser"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::All,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.narrow_projection_all",
        p1_scenario_id: "user.contract.exact_primary_key",
        sql_override: Some("SELECT id, name FROM PerfAuditUser"),
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
        selectivity: ScaleSelectivity::All,
        result_window: None,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.unsupported_order.all.window1",
        p1_scenario_id: "user.select.pk.all.numeric_expr_asc.limit1",
        sql_override: None,
        surface: MatrixSurface::User,
    ...
    ScaleSentinelSpec {
        sentinel_id: "heap_user.primary_order.all.window1",
        p1_scenario_id: "heap_user.select.pk.all.pk_asc.limit1",
        sql_override: None,
        surface: MatrixSurface::HeapUser,
        route_family: RouteFamily::PrimaryOrder,
        selectivity: ScaleSelectivity::All,
    ...
    ScaleSentinelSpec {
        sentinel_id: "journaled_user.primary_order.all.window1",
        p1_scenario_id: "journaled_user.select.pk.all.pk_asc.limit1",
        sql_override: None,
        surface: MatrixSurface::JournaledUser,
        route_family: RouteFamily::PrimaryOrder,
        selectivity: ScaleSelectivity::All,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.primary_order.all.offset1.window3",
        p1_scenario_id: "user.contract.limit_offset",
        sql_override: None,
        surface: MatrixSurface::User,
        route_family: RouteFamily::PrimaryOrder,
        selectivity: ScaleSelectivity::All,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.secondary_order.quarter.wide.window10",
        p1_scenario_id: "user.select.wide.age_range.age_asc.limit10",
        sql_override: None,
        surface: MatrixSurface::User,
        route_family: RouteFamily::SecondaryOrder,
        selectivity: ScaleSelectivity::Quarter,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.materialized_projection.all.window3",
        p1_scenario_id: "user.contract.computed_projection",
        sql_override: None,
        surface: MatrixSurface::User,
        route_family: RouteFamily::MaterializedOrder,
        selectivity: ScaleSelectivity::All,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.sum_all",
        p1_scenario_id: "user.aggregate.sum_age",
        sql_override: None,
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
    ...
    ScaleSentinelSpec {
        sentinel_id: "user.not_paginated.aggregate_distinct_filter_all",
        p1_scenario_id: "user.contract.aggregate_distinct_filter",
        sql_override: None,
        surface: MatrixSurface::User,
        route_family: RouteFamily::NotOrderedOrNotPaginated,
    ...
    ScaleSentinelSpec {
        sentinel_id: "blob.secondary_metadata.quarter.window10",
        p1_scenario_id: "blob.select.metadata.bucket_eq.bucket_label_asc.limit10",
        sql_override: None,
        surface: MatrixSurface::Blob,
        route_family: RouteFamily::SecondaryOrder,
        selectivity: ScaleSelectivity::Quarter,
    ...
    ScaleSentinelSpec {
        sentinel_id: "blob.secondary_lengths.quarter.window10",
        p1_scenario_id: "blob.select.lengths.bucket_eq.bucket_label_asc.limit10",
        sql_override: None,
        surface: MatrixSurface::Blob,
        route_family: RouteFamily::SecondaryOrder,
        selectivity: ScaleSelectivity::Quarter,
    ...
    ScaleSentinelSpec {
        sentinel_id: "blob.secondary_thumbnail.quarter.window10",
        p1_scenario_id: "blob.select.thumbnail.bucket_eq.bucket_label_asc.limit10",
        sql_override: None,
        surface: MatrixSurface::Blob,
        route_family: RouteFamily::SecondaryOrder,
        selectivity: ScaleSelectivity::Quarter,
    ...
    ScaleSentinelSpec {
        sentinel_id: "token.branch_set.quarter.page_only.window50",
        p1_scenario_id: "token.collection_stage_id.branch_set.page_only.limit50",
        sql_override: None,
        surface: MatrixSurface::Token,
        route_family: RouteFamily::SecondaryOrder,
        selectivity: ScaleSelectivity::Quarter,
    ...
    ScaleSentinelSpec {
        sentinel_id: "token.branch_set.quarter.covering.window50",
        p1_scenario_id: "token.collection_stage_id.branch_set.covering_page_only.limit50",
        sql_override: None,
        surface: MatrixSurface::Token,
        route_family: RouteFamily::SecondaryOrder,
        selectivity: ScaleSelectivity::Quarter,
    ...
    ScaleSentinelSpec {
        sentinel_id: "token.branch_set.quarter.noncovered.window50",
        p1_scenario_id: "token.collection_stage_id.branch_set.noncovered_page_only.limit50",
        sql_override: None,
        surface: MatrixSurface::Token,
        route_family: RouteFamily::SecondaryOrder,
        selectivity: ScaleSelectivity::Quarter,
    ...
    ScaleSentinelSpec {
        sentinel_id: "token.branch_set.quarter.full_entity.window50",
        p1_scenario_id: "token.collection_stage_id.branch_set.full_entity.limit50",
        sql_override: None,
        surface: MatrixSurface::Token,
        route_family: RouteFamily::SecondaryOrder,
        selectivity: ScaleSelectivity::Quarter,
    ...
    ScaleSentinelSpec {
        sentinel_id: "token.branch_set_wide.quarter.page_only.window50",
        p1_scenario_id: "token.collection_stage_id.branch_set.wide_page_only.limit50",
        sql_override: None,
        surface: MatrixSurface::Token,
        route_family: RouteFamily::SecondaryOrder,
        selectivity: ScaleSelectivity::Quarter,
    ...
    ScaleSentinelSpec {
        sentinel_id: "token.branch_set_wide.quarter.noncovered.window50",
        p1_scenario_id: "token.collection_stage_id.branch_set.wide_noncovered_page_only.limit50",
        sql_override: None,
        surface: MatrixSurface::Token,
        route_family: RouteFamily::SecondaryOrder,
        selectivity: ScaleSelectivity::Quarter,
    ...
    ScaleSentinelSpec {
        sentinel_id: "token.branch_over_cap.quarter.page_only.window50",
        p1_scenario_id: "token.collection_stage_id.overcap_fallback.page_only.limit50",
        sql_override: None,
        surface: MatrixSurface::Token,
        route_family: RouteFamily::MaterializedOrder,
        selectivity: ScaleSelectivity::Quarter,
    ...
    ScaleSentinelSpec {
        sentinel_id: "token.branch_over_cap.quarter.noncovered.window50",
        p1_scenario_id: "token.collection_stage_id.overcap_fallback.noncovered_page_only.limit50",
        sql_override: None,
        surface: MatrixSurface::Token,
        route_family: RouteFamily::MaterializedOrder,
        selectivity: ScaleSelectivity::Quarter,
    ...
    ScaleSentinelSpec {
        sentinel_id: "token.branch_at_cap.quarter.page_only.window50",
        p1_scenario_id: "token.collection_stage_id.branch_set.wide_page_only.limit50",
        sql_override: Some(
    ...
    ScaleSentinelSpec {
        sentinel_id: "token.branch_at_cap.quarter.count",
        p1_scenario_id: "token.collection_stage_id.branch_set.count",
        sql_override: Some(
    ...
    ScaleSentinelSpec {
        sentinel_id: "token.branch_over_cap.quarter.count",
        p1_scenario_id: "token.collection_stage_id.branch_set.count",
        sql_override: Some(
            "SELECT COUNT(*) FROM PerfAuditToken \
             WHERE collection_id = '01KV5N439P0000000000000000' \
    ...
    ScaleSentinelSpec {
        sentinel_id: "heap_user.materialized_order_full_entity.all.window10",
        p1_scenario_id: "heap_user.select.full_entity.all.age_asc.limit10",
        sql_override: None,
        surface: MatrixSurface::HeapUser,
        route_family: RouteFamily::MaterializedOrder,
        selectivity: ScaleSelectivity::All,
    ...
    ScaleSentinelSpec {
        sentinel_id: "journaled_user.materialized_order_full_entity.all.window10",
        p1_scenario_id: "journaled_user.select.full_entity.all.age_asc.limit10",
        sql_override: None,
        surface: MatrixSurface::JournaledUser,
        route_family: RouteFamily::MaterializedOrder,
        selectivity: ScaleSelectivity::All,
    ...
    ScaleSentinelSpec {
        sentinel_id: "journaled_user.materialized_order.all.window1",
        p1_scenario_id: "journaled_user.select.pk.all.age_asc.limit1",
        sql_override: None,
        surface: MatrixSurface::JournaledUser,
        route_family: RouteFamily::MaterializedOrder,
        selectivity: ScaleSelectivity::All,
...
mod tests {
    ...
    fn scale_profile_has_every_declared_cardinality_route_selectivity_and_window() {
        ...
        assert_eq!(scale_sentinel_specs().len(), 70);
        let sentinel_ids = scale_sentinel_specs()
            .iter()
            .map(|spec| spec.sentinel_id)
            .collect::<BTreeSet<_>>();
        for required in [
            "blob.secondary_lengths.quarter.window10",
            "blob.secondary_metadata.quarter.window10",
            "blob.secondary_thumbnail.quarter.window10",
            "heap_user.materialized_order_full_entity.all.window10",
            "journaled_user.materialized_order_full_entity.all.window10",
            "token.branch_over_cap.quarter.noncovered.window50",
            "token.branch_over_cap.quarter.page_only.window50",
            "token.branch_at_cap.quarter.count",
            "token.branch_at_cap.quarter.page_only.window50",
            "token.branch_over_cap.quarter.count",
            "token.branch_set.quarter.covering.window50",
            "token.branch_set.quarter.full_entity.window50",
            "token.branch_set.quarter.noncovered.window50",
            "token.branch_set.quarter.page_only.window50",
            "token.branch_set_wide.quarter.noncovered.window50",
            "token.branch_set_wide.quarter.page_only.window50",
            "user.materialized_projection.all.window3",
            "user.not_paginated.aggregate_distinct_filter_all",
            "user.not_paginated.count_constant_one_all",
            "user.not_paginated.count_indexed_in_all",
            "user.not_paginated.count_nonnull_id_all",
            "user.not_paginated.count_true_all",
            "user.not_paginated.max_primary_all",
            "user.not_paginated.max_secondary_all",
            "user.not_paginated.max_secondary_range_quarter",
            "user.not_paginated.min_computed_all",
            "user.not_paginated.min_primary_all",
            "user.not_paginated.min_secondary_all",
            "user.not_paginated.min_secondary_range_all",
            "user.not_paginated.sum_all",
            "user.primary_order.all.offset1.window3",
            "user.secondary_order.quarter.wide.window10",
            "user.secondary_order.all.first_age.window1",
            "user.secondary_order.all.last_age.window1",
        ] {
            assert!(
                sentinel_ids.contains(required),
                "expanded hotspot scale profile lost {required:?}",
            );
        }
        for spec in scale_sentinel_specs() {
