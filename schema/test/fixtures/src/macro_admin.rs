...
#[entity(
    ...
    fields(
        ...
        field(ident = "int_candid", value(item(prim = "IntBig"))),
        ...
        field(ident = "nat_candid", value(item(prim = "NatBig"))),
        field(ident = "nat_8", value(item(prim = "Nat8"))),
        field(ident = "nat_16", value(item(prim = "Nat16"))),
        field(ident = "nat_64", value(item(prim = "Nat64"))),
        field(ident = "e8s", value(item(is = "base::types::finance::E8s"))),
        field(ident = "e18s", value(item(is = "base::types::finance::E18s"))),
