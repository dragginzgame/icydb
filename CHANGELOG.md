...
- `0.261.1` simplifies schema, startup and typed-binding internals and documents lower-cost catalogue reads and schedule-dependent Toko Miner back-pressure, preserving runtime behavior.
