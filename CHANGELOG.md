...
- `0.43.3` improves runtime plan stability by centralizing access-shape capability checks behind one shared access boundary, reducing duplicate routing logic and tightening guard coverage for raw access-path usage.
