...
- `0.149.17` removes executor-authority generated schema reopening from runtime plan validation, requiring executor-bound plans to carry planner-frozen static shape that session planning already finalized from accepted schema metadata.
