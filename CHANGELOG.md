...
- `0.257.5` adds SQL-free typed query explanations, improves application model integration and reduces startup allocation and preparation overhead (breaking: databases require recreation; explain fingerprints are removed; canonical summaries replace raw dumps and return results; excessive diagnostic depth rejects; bigint limb helpers return borrowed iterators; newly charged construction can reject requests).
