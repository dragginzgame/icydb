...
- `0.147.3` makes typed saves and SQL writes prove accepted row-layout compatibility before staging or shaping mutations, reports early typed-save schema guard failures in save error metrics, and carries explicit text/blob length limits through accepted schema metadata.
