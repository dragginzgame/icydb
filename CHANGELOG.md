...
- `0.153.11` adds closeout guard/docs for the schema rebuild runner minor, locking field-path runner modules to accepted runner input, execution plans, and rebuild targets without generated `EntityModel`/`IndexModel` authority, and recording the completed 0.153 field-path runner foundation versus the intentionally deferred 0.154 reconciliation/recovery work.
