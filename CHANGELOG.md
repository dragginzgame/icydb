...
- `0.80.3` widens one small SQL projection boundary so scalar `SELECT` lists can now do bounded field-to-field arithmetic like `dexterity + charisma AS total`, without opening arithmetic predicates, grouped arithmetic, or broader expression parsing.
