...
- `0.147.7` makes structural row decode open persisted rows through the frozen row-layout contract instead of retaining generated model metadata at that boundary.
